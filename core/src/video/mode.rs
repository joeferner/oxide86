...
impl Mode {
    ...
    pub fn resolution(&self) -> (u32, u32) {
        match self {
            ...
            Mode::M04Cga320x200x4 | Mode::M05Cga320x200x4 => (320, 200),
    ...
    pub fn get_text_dimensions(&self) -> Option<TextDimensions> {
        match self {
            ...
            Mode::M11Vga640x480x2 => Some(TextDimensions { rows: 30, cols: 80 }),
