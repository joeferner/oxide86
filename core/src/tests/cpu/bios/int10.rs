use crate::tests::{run_test, run_test_vga};
...
pub(crate) fn set_color_palette() {
    run_test("cpu/bios/int10/set_color_palette");
}
...
pub(crate) fn character_generator() {
    run_test_vga("cpu/bios/int10/character_generator");
}
...
pub(crate) fn return_physical_display_params() {
    run_test_vga("cpu/bios/int10/return_physical_display_params");
}
...
pub(crate) fn display_combination_code() {
    run_test_vga("cpu/bios/int10/display_combination_code");
}
...
pub(crate) fn get_video_buffer() {
    run_test("cpu/bios/int10/get_video_buffer");
}
