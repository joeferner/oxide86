...
// MIGRATED  // IVT (Interrupt Vector Table) constants
// MIGRATED  pub const IVT_START: usize = 0x0000;
// MIGRATED  pub const IVT_END: usize = 0x03FF;
// MIGRATED  pub const IVT_ENTRY_SIZE: usize = 4; // Each entry is 4 bytes (offset, segment)

// MIGRATED  // BIOS data area and interrupt handler locations
// MIGRATED  pub const BIOS_INTERRUPT_HANDLERS: usize = 0xF000; // Segment where BIOS handlers are located

// MIGRATED  // BIOS Data Area (BDA) constants
// MIGRATED  pub const BDA_SEGMENT: u16 = 0x0040;
// MIGRATED  pub const BDA_START: usize = 0x0400; // Physical address (0x40 * 16)
// MIGRATED  pub const BDA_SIZE: usize = 0x100; // 256 bytes
// MIGRATED  
// MIGRATED  // BDA field offsets (from 0x0040:0000)
// MIGRATED  pub const BDA_COM_PORTS: usize = 0x00; // COM1-COM4 port addresses (4 words)
// MIGRATED  pub const BDA_LPT_PORTS: usize = 0x08; // LPT1-LPT4 port addresses (4 words)
// MIGRATED  pub const BDA_EQUIPMENT_LIST: usize = 0x10; // Equipment list word
// MIGRATED  pub const BDA_MEMORY_SIZE: usize = 0x13; // Memory size in KB (word)
// MIGRATED  pub const BDA_KEYBOARD_FLAGS1: usize = 0x17; // Keyboard shift flags
// MIGRATED  pub const BDA_KEYBOARD_FLAGS2: usize = 0x18; // Keyboard shift flags
// MIGRATED  pub const BDA_KEYBOARD_BUFFER_HEAD: usize = 0x1A; // Keyboard buffer head pointer
// MIGRATED  pub const BDA_KEYBOARD_BUFFER_TAIL: usize = 0x1C; // Keyboard buffer tail pointer
// MIGRATED  pub const BDA_KEYBOARD_BUFFER: usize = 0x1E; // Keyboard buffer (32 bytes)
// MIGRATED  pub const BDA_VIDEO_MODE: usize = 0x49; // Current video mode
// MIGRATED  pub const BDA_SCREEN_COLUMNS: usize = 0x4A; // Number of screen columns
// MIGRATED  pub const BDA_VIDEO_PAGE_SIZE: usize = 0x4C; // Video page size in bytes
// MIGRATED  pub const BDA_VIDEO_PAGE_OFFSET: usize = 0x4E; // Current page start address
// MIGRATED  pub const BDA_CURSOR_POS: usize = 0x50; // Cursor positions for 8 pages (16 bytes)
// MIGRATED  pub const BDA_CURSOR_END_LINE: usize = 0x60; // Cursor end scan line
// MIGRATED  pub const BDA_CURSOR_START_LINE: usize = 0x61; // Cursor start scan line
// MIGRATED  pub const BDA_ACTIVE_PAGE: usize = 0x62; // Active display page
// MIGRATED  pub const BDA_CRTC_PORT: usize = 0x63; // CRT controller base port address
// MIGRATED  pub const BDA_CRT_MODE_CONTROL: usize = 0x65; // CRT mode control register
// MIGRATED  pub const BDA_CRT_PALETTE: usize = 0x66; // CRT palette register
// MIGRATED  pub const BDA_TIMER_COUNTER: usize = 0x6C; // Timer counter (dword) - ticks since midnight
// MIGRATED  pub const BDA_TIMER_OVERFLOW: usize = 0x70; // Timer midnight rollover flag (byte)
// MIGRATED  pub const BDA_NUM_HARD_DRIVES: usize = 0x75; // Number of hard drives installed (byte)
// MIGRATED  pub const BDA_KEYBOARD_BUFFER_START: usize = 0x80; // Keyboard buffer start pointer (word, normally 0x001E)
// MIGRATED  pub const BDA_KEYBOARD_BUFFER_END: usize = 0x82; // Keyboard buffer end pointer (word, normally 0x003E)
// MIGRATED  pub const BDA_EGA_ROWS: usize = 0x84; // EGA/VGA: number of rows on screen minus 1 (byte, e.g. 24 for 25-row mode)
// MIGRATED  pub const BDA_EGA_CHAR_HEIGHT: usize = 0x85; // EGA/VGA: bytes per character (byte, e.g. 16 for 8x16 font)
// MIGRATED  pub const BDA_MOUSE_X: usize = 0xE0; // Mouse X position (word)
// MIGRATED  pub const BDA_MOUSE_Y: usize = 0xE2; // Mouse Y position (word)
// MIGRATED  pub const BDA_MOUSE_BUTTONS: usize = 0xE4; // Mouse button state (byte)
// MIGRATED  pub const BDA_MOUSE_VISIBLE: usize = 0xE5; // Mouse cursor visibility counter (byte)
// MIGRATED  pub const BDA_MOUSE_MIN_X: usize = 0xE6; // Mouse horizontal minimum (word)
// MIGRATED  pub const BDA_MOUSE_MAX_X: usize = 0xE8; // Mouse horizontal maximum (word)
// MIGRATED  pub const BDA_MOUSE_MIN_Y: usize = 0xEA; // Mouse vertical minimum (word)
// MIGRATED  pub const BDA_MOUSE_MAX_Y: usize = 0xEC; // Mouse vertical maximum (word)

// MIGRATED  // Equipment list bits
// MIGRATED  pub const EQUIPMENT_FLOPPY_INSTALLED: u16 = 0x0001;
// MIGRATED  pub const EQUIPMENT_MATH_COPROCESSOR: u16 = 0x0002;
// MIGRATED  pub const EQUIPMENT_POINTING_DEVICE: u16 = 0x0004; // PS/2 mouse
// MIGRATED  pub const EQUIPMENT_VIDEO_MODE_MASK: u16 = 0x0030; // Bits 4-5: initial video mode
// MIGRATED  pub const EQUIPMENT_VIDEO_MODE_80X25_COLOR: u16 = 0x0020;
// MIGRATED  pub const EQUIPMENT_VIDEO_MODE_80X25_MONO: u16 = 0x0030;
// MIGRATED  pub const EQUIPMENT_FLOPPY_COUNT_MASK: u16 = 0x00C0; // Bits 6-7: number of floppies - 1
// MIGRATED  pub const EQUIPMENT_SERIAL_COUNT_MASK: u16 = 0x0E00; // Bits 9-11: number of serial ports
// MIGRATED  pub const EQUIPMENT_PRINTER_COUNT_MASK: u16 = 0xC000; // Bits 14-15: number of printers
