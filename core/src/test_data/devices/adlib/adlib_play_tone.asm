; adlib_play_tone.asm - Enable an OPL2 voice and play a brief tone
;
; Sets up channel 0 with a simple sustained sine wave, triggers key_on,
; waits long enough to generate audio samples, then exits.
;
; Used by the Rust-level ring-buffer test to verify that FM synthesis
; actually produces non-zero PCM samples.
;
