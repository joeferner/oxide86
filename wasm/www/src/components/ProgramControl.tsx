...
export function ProgramControl({ onLoadProgram, onReset }: ProgramControlProps) {
  ...
  return (
    <Stack gap="xs" p="sm" style={{ border: '1px solid var(--mantine-color-dark-4)', borderRadius: 4 }}>
      <Group gap="xs" align="center">
        <Text fw={500} size="sm" style={{ minWidth: 100, textAlign: 'right' }}>Program File:</Text>
        <FileButton onChange={setFile} accept=".com,.bin,.exe">
          {(props) => <Button {...props} size="compact-sm" color="blue">
      ...
      <Group gap="xs" align="center">
        <Text fw={500} size="sm" style={{ minWidth: 100, textAlign: 'right' }}>Segment:</Text>
        <TextInput
          placeholder="0x0000"
          value={segment}
      ...
      <Group gap="xs" align="center">
        <Text fw={500} size="sm" style={{ minWidth: 100, textAlign: 'right' }}>Offset:</Text>
        <TextInput
          placeholder="0x0100"
          value={offset}
